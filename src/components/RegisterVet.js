...
import logoVet from "../logo-veterinarios.png"
    ...
    return (
        <>
            <div className="logomodal">
                <img src={logoVet} className="App-logo" />
            </div>
            ...
            <Row>
                <Col>
                    ...
                    <FloatingLabel controlId="floatingVet" label="Nombre Veterinaria" className="forminput">
                        <Form.Control type="text" />
                    </FloatingLabel>
